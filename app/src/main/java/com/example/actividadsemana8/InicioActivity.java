...
public class InicioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tablas=findViewById(R.id.tablas);
        vision=findViewById(R.id.txt_tablas);
        seguir=findViewById(R.id.log);
        seguir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent a=new Intent(getApplicationContext(),integrantes.class);
                startActivity(a);
            }
        });
        String tablaso[]={"Seleccione una tabla","tabla 1", "tabla 2", "tabla 3", "tabla 4","tabla 5", "tabla 6", "tabla 7", "tabla 8", "tabla 9", "tabla 10",};
